...
*
*******************************************************************************/
void RTC_1_EverySecondHandler(void)
{
...
*
*******************************************************************************/
void RTC_1_EveryMinuteHandler(void)
{
...
*
*******************************************************************************/
void RTC_1_EveryHourHandler(void)
{
...
*
*******************************************************************************/
void RTC_1_EveryDayHandler(void)
{
...
*
*******************************************************************************/
void RTC_1_EveryWeekHandler(void)
{
...
*
*******************************************************************************/
void RTC_1_EveryMonthHandler(void)
{
...
*
*******************************************************************************/
void RTC_1_EveryYearHandler(void)
{
...
CY_ISR(RTC_1_ISR)
{
    ...
    if(RTC_1_currentTimeDate.Sec > RTC_1_MINUTE_ELAPSED)
    {
        ...
        if(RTC_1_currentTimeDate.Min > RTC_1_HOUR_ELAPSED)
        {
            ...
            if(RTC_1_currentTimeDate.Hour > RTC_1_DAY_ELAPSED)
            {
                ...
                */
                if((((0u != (RTC_1_statusDateTime & RTC_1_STATUS_LY)) && \
                   ...
                   (RTC_1_currentTimeDate.DayOfMonth > \
                                    RTC_1_daysInMonths[RTC_1_currentTimeDate.Month-1] + 1)) || \
                   (((0u != (RTC_1_statusDateTime & RTC_1_STATUS_LY)) && \
                    (!(RTC_1_currentTimeDate.Month == RTC_1_FEBRUARY))) && \
                    (RTC_1_currentTimeDate.DayOfMonth > \
                                    RTC_1_daysInMonths[RTC_1_currentTimeDate.Month-1])) || \
                   ((!(0u != (RTC_1_statusDateTime & RTC_1_STATUS_LY))) && \
                   (RTC_1_currentTimeDate.DayOfMonth > \
                                    RTC_1_daysInMonths[RTC_1_currentTimeDate.Month-1])))
                {                
                    ...
                    if(RTC_1_currentTimeDate.Month > RTC_1_YEAR_ELAPSED)
                    {
                        ...
                        /* Every Year */
                        if(RTC_1_IS_BIT_SET(RTC_1_intervalCfgMask, \
                ...
                /* Every Day */
                if(RTC_1_IS_BIT_SET(RTC_1_intervalCfgMask, RTC_1_INTERVAL_DAY_MASK))
                {
            ...
            else
            {
                ...
                if(RTC_1_IS_BIT_SET(RTC_1_dstModeType, RTC_1_DST_ENABLE))
                {
                    ...
                    {
                        if(RTC_1_IS_BIT_SET(RTC_1_dstStopStatus, RTC_1_DST_HOUR    | \
                                                                                    ...
                                                                                    RTC_1_DST_MONTH))
                        {
                            ...
                            */
                            ...
                            if(RTC_1_currentTimeDate.Min > RTC_1_HOUR_ELAPSED)
                            {
                                ...
                                */
                                RTC_1_currentTimeDate.Min = \
                                                RTC_1_HOUR_ELAPSED - (~RTC_1_currentTimeDate.Min);
                            ...
                            * Is hour value negative? */
                            if(RTC_1_currentTimeDate.Hour > RTC_1_DAY_ELAPSED)
                            {
                                ...
                                */
                                RTC_1_currentTimeDate.Hour = \
                                                RTC_1_DAY_ELAPSED - (~RTC_1_currentTimeDate.Hour);
                    ...
                    /* Alarm DAYOFMONTH */
                    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, \
            ...
            /* Every Hour */
            if(RTC_1_IS_BIT_SET(RTC_1_intervalCfgMask,RTC_1_INTERVAL_HOUR_MASK))
            {
        ...
        /* Every Min */
        if(RTC_1_IS_BIT_SET(RTC_1_intervalCfgMask, RTC_1_INTERVAL_MIN_MASK))
        {
    ...
    if(RTC_1_IS_BIT_SET(RTC_1_intervalCfgMask,RTC_1_INTERVAL_SEC_MASK))
    {
