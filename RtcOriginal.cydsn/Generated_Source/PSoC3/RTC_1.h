...
typedef struct _RTC_1_TIME_DATE
{
    uint8 Sec;
    uint8 Min;
    uint8 Hour;
...
#define RTC_1_ISR_NUMBER             RTC_1_isr__INTC_NUMBER

/* Priority of the RTC_1_isr interrupt */
#define RTC_1_ISR_PRIORITY           RTC_1_isr__INTC_PRIOR_NUM
...
#define RTC_1_LEAP_YEAR(year) ((!((year) % 400u) || (!((year) % 4u) && ((year) % 100u))) ? 0x01u : 0x00u)
...
#define RTC_1_SET_ALARM(alarmCfg, alarmCur, status) \
    if((alarmCfg) && (RTC_1_IS_BIT_SET((alarmCur),(alarmCfg)))) \
    { \
...
#define RTC_1_IsLeapYear         RTC_1_LEAP_YEAR
#define RTC_1_Dst                RTC_1_DSTIME
#define RTC_1_TimeDate           RTC_1_TIME_DATE

#define RTC_1_CurTimeDate        RTC_1_currentTimeDate
#define RTC_1_AlarmTimeDate      RTC_1_alarmCfgTimeDate

#if (1u == RTC_1_DST_FUNC_ENABLE)
    #define RTC_1_DstMode            RTC_1_dstModeType
    #define RTC_1_DstStartTimeDate   RTC_1_dstTimeDateStart
    #define RTC_1_DstStopTimeDate    RTC_1_dstTimeDateStop
    
    #define RTC_1_DstOffset          RTC_1_dstOffsetMin
    #define RTC_1_DstStatusStart     RTC_1_dstStartStatus
    #define RTC_1_DstStatusStop      RTC_1_dstStopStatus
#endif /* 1u == RTC_1_DST_FUNC_ENABLE */

#define RTC_1_AlarmMask      RTC_1_alarmCfgMask
#define RTC_1_AlarmStatus    RTC_1_alarmCurStatus
#define RTC_1_IntervalMask   RTC_1_intervalCfgMask
#define RTC_1_Status         RTC_1_statusDateTime
#define RTC_1_Dim            RTC_1_daysInMonths
#define RTC_1_Seq            RTC_1_monthTemplate
...
extern const uint8 CYCODE   RTC_1_monthTemplate [RTC_1_MONTHS_IN_YEAR];
