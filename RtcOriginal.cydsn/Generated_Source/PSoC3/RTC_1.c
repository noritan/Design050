...
/* Function Prototypes */
void RTC_1_SetInitValues(void) ;
uint8 RTC_1_DayOfWeek(uint8, uint8, uint16) ;
...
/* Calculated sequence (31 * month )/ 12 ) mod 7 from the Zeller's congruence */
 const uint8 CYCODE RTC_1_monthTemplate[RTC_1_MONTHS_IN_YEAR] = \
...
void RTC_1_Stop(void) 
{
    ...
    RTC_1_OPPS_CFG_REG &= ~(RTC_1_OPPSIE_EN_MASK | RTC_1_OPPS_EN_MASK);
...
void RTC_1_DisableInt(void) 
{
    ...
    *
    *******************************************************************************/
    void RTC_1_DSTDateConversion(void) 
    {
        uint8 week = 1u;
        uint8 day = 1u;
        uint8 dayOfWeek;
...
void RTC_1_Init(void) 
{
    ...
    CyIntSetVector(RTC_1_ISR_NUMBER, RTC_1_ISR);
...
*
* Parameters:
*  timeDate: Pointer to RTC_1_TIME_DATE global stucture where new 
...
*
*******************************************************************************/
void RTC_1_WriteTime(RTC_1_TIME_DATE *timeDate) 
{
...
uint8 RTC_1_ReadStatus(void) 
{
    ...
    RTC_1_statusDateTime &= ~RTC_1_STATUS_AA;
...
*
*******************************************************************************/
uint8 RTC_1_DayOfWeek(uint8 dayOfMonth, uint8 month, uint16 year) 
{
    ...
    */
    ...
    return ((uint8)((year + year/4 - year/100 + year/400 + RTC_1_monthTemplate[month-1] + dayOfMonth) % \
                    RTC_1_DAYS_IN_WEEK));
}
...
void RTC_1_SetInitValues(void) 
{
    ...
    /* Leap year check */
    if(RTC_1_IS_BIT_SET(RTC_1_statusDateTime, RTC_1_STATUS_LY))
    {
        /* Leap day check */
        if(!(RTC_1_currentTimeDate.DayOfMonth <= RTC_1_DAYS_IN_FEBRUARY + 1u &&
    ...
    else
    {
        ...
        * values
        */
        if(RTC_1_IS_BIT_SET(RTC_1_dstModeType, RTC_1_DST_RELDATE))
        {
        ...
        */   
        ...
        /* DST Enable ? */
        if(RTC_1_IS_BIT_SET(RTC_1_dstModeType, RTC_1_DST_ENABLE))
        {
            if(RTC_1_IS_BIT_SET(RTC_1_statusDateTime,RTC_1_STATUS_DST))
            {
                if(RTC_1_IS_BIT_SET(RTC_1_dstStartStatus, \
            ...
            {
                if(RTC_1_IS_BIT_SET(RTC_1_dstStartStatus, RTC_1_DST_HOUR       | \
                                                                                RTC_1_DST_DAYOFMONTH | \
                                                                                RTC_1_DST_MONTH))  
                {
                    /* Add Hour and Min */
                    RTC_1_currentTimeDate.Min += \
    ...
    /* Alarm SEC */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask,RTC_1_ALARM_SEC_MASK))
    {
        if(RTC_1_alarmCfgTimeDate.Sec == RTC_1_currentTimeDate.Sec)
        {
            /* Set second alarm */
    ...
    /* Alarm MIN */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, RTC_1_ALARM_MIN_MASK))
    {
        if(RTC_1_alarmCfgTimeDate.Min == RTC_1_currentTimeDate.Min)
        {
            /* Set minute alarm */
    ...
    /* Alarm HOUR */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, RTC_1_ALARM_HOUR_MASK))
    {
        if(RTC_1_alarmCfgTimeDate.Hour == RTC_1_currentTimeDate.Hour)
        {
            /* Set hour alarm */
    ...
    /* Alarm DAYOFWEEK */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, RTC_1_ALARM_DAYOFWEEK_MASK))
    {
        if(RTC_1_alarmCfgTimeDate.DayOfWeek == RTC_1_currentTimeDate.DayOfWeek)
        {
            /* Set day of week alarm */
    ...
    /* Alarm DAYOFYEAR */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, RTC_1_ALARM_DAYOFYEAR_MASK))
    {
        if(RTC_1_alarmCfgTimeDate.DayOfYear == RTC_1_currentTimeDate.DayOfYear)
        {
            /* Set day of year alarm */
    ...
    /* Alarm DAYOFMONTH */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, RTC_1_ALARM_DAYOFMONTH_MASK))
    {
        if (RTC_1_alarmCfgTimeDate.DayOfMonth == RTC_1_currentTimeDate.DayOfMonth)
        {
            /* Set day of month alarm */
    ...
    /* Alarm MONTH */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, RTC_1_ALARM_MONTH_MASK))
    {
        if(RTC_1_alarmCfgTimeDate.Month == RTC_1_currentTimeDate.Month)
        {
            /* Set month alarm */
    ...
    /* Alarm YEAR */
    if(RTC_1_IS_BIT_SET(RTC_1_alarmCfgMask, RTC_1_ALARM_YEAR_MASK))
    {
        if(RTC_1_alarmCfgTimeDate.Year == RTC_1_currentTimeDate.Year)
        {
            /* Set year alarm */
    ...
    RTC_1_SET_ALARM(RTC_1_alarmCfgMask,   \
    ...
    *******************************************************************************/
    void RTC_1_WriteDSTMode(uint8 mode) 
    {
        ...
        if(RTC_1_IS_BIT_SET(mode,RTC_1_DST_RELDATE))
        {
            /* Convert DST date */
            RTC_1_DSTDateConversion();
        }
